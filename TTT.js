...
for(var i=0; i<9; i++)
{
    boxes[i].addEventListener("click", function(){
        ...
        if(count%2==0 && this.textContent=="" && ist)      // here we check the whom the chaall is like initially count=0 meand even chaal is O and 
        {
            this.textContent="O";                          // count global var.
            count++;
            check();
        }
...
function check()    //8 methosd to win
{
